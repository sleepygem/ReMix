...
public:
	 ...
	 */
	FRefPoseOverrideMod(const USkeletalMesh* ReferenceMesh)
	{
...
protected:
	...
	friend class FSkeletalMeshMergeModified;
};

struct FSkelMeshMaterialOverride
{
	/** Materials for a particular mesh being merged. */
...
*/
class REMIX_API FSkeletalMeshMergeModified
{
public:
	/**
	* Constructor
	...
	* @param MaterialOverrides - optional array to override the materials for each mesh being merged
	...
	*/
	 ...
	 */
	bool DoMerge(TArray<FRefPoseOverrideMod>* RefPoseOverrides = nullptr);
	 ...
	 * @param RefPoseOverrides - An optional override for the merged skeleton's reference pose.
	 */
	void MergeSkeleton(const TArray<FRefPoseOverrideMod>* RefPoseOverrides = nullptr);
...
private:
	...
	*/
	 ...
	 */
	static void OverrideReferenceSkeletonPose(const TArray<FRefPoseOverrideMod>& PoseOverrides, FReferenceSkeleton& TargetSkeleton, const USkeleton* SkeletonAsset);
	...
	//void OverrideSockets(const TArray<FRefPoseOverrideMod>& PoseOverrides);
	 ...
	 */
	void OverrideMergedSockets(const TArray<FRefPoseOverrideMod>& PoseOverrides);
