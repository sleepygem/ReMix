...
struct REMIX_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
/**
* Used to override base materials in each mesh
*/
USTRUCT(BlueprintType)
struct REMIX_API FMaterialOverride 
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct REMIX_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct REMIX_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct REMIX_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class REMIX_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Mesh Merge", meta = (UnsafeDuringActorConstruction = "true"))
        static class USkeletalMesh* MergeMeshes(const FSkeletalMeshMergeParams& Params, TArray<FMaterialOverride> MaterialOverrides);
};